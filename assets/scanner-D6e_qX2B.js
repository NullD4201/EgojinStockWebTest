import{Html5Qrcode as f}from"./index-CkUeu7at.js";import{p as v}from"./qr-generator-CkRw2xrd.js";import{u as s,o as g,r as h,q as w}from"./index-Pn9Rsdm9.js";let o=null,i=!1;async function k(){const t=document.getElementById("scan-result"),a=document.getElementById("scanner-prompt");i=!1,document.getElementById("start-camera-btn")?.addEventListener("click",()=>{E(t,a)}),document.getElementById("test-scan-btn")?.addEventListener("click",async()=>{const n=JSON.stringify({type:"part",partId:2,locationId:"1850602233108"});await b(n)})}async function E(t,a){try{o=new f("qr-reader");const n={fps:10,qrbox:{width:250,height:250},aspectRatio:1};await o.start({facingMode:"environment"},n,b,I),i=!0,a.style.display="none",s.showToast("카메라가 시작되었습니다","success")}catch(n){console.error("Camera error:",n),t.innerHTML=`
